(function() 
 {
  var allQuestions = [{
    question: "What material speaks to you the most?",
    options: ["wood", "Marmer", "Platinum", "Diamond"],
    answer: [40, 20, 30, 10],
  }, {
    question: "What animal do you like most?",
   ...
   function displayResult() 
    {
        ...
        score.append('Based on your awnsers we think this artwork suits you the best!');
